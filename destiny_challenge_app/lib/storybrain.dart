...
class StoryBrain {
  ...
  void nextStory(choice) {
    List<int> endList = [3, 4, 5];
    if (!endList.contains(_storyNumber)) {
      // print('go ahead to next story');
  ...
  String getChoice(int choice) {
    late String _choiceMade;

    if (choice == 1) {
      _choiceMade = _storyList[_storyNumber].choice1;
    } else if (choice == 2) {
      _choiceMade = _storyList[_storyNumber].choice2;
    }
  ...
  bool buttonVisibility() {
    List<int> _choices = [0, 1, 2];
    if (_choices.contains(_storyNumber))
      return true;
    else
      return false;
  }

  // void storyUpdate(choice) {}
}
